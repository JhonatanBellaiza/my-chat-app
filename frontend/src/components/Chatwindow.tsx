...
function Chatwindow() {
  ...
  if (errorSub) {
    console.error("Subscription Error:", errorSub);
  }

  useEffect(() => {
    scrollToBottom()
    console.log("TESTING DATASUB NewMessage: ##### " + dataSub?.newMessage)
    ...
    console.log("TESTING DATASUB AFTER:  " + dataSub?.newMessage)
              ...
              >
                ...
                >
                  <Flex {...getRootProps()} align="center">
                    ...
                    <Button leftIcon={<IconPhotoUp />}></Button>
                    <input 
                      type="file"
                      accept="image/*"
                      style={{ display: "none" }}
